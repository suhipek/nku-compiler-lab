...
public:
    ...
    void setLastCond(int cond){lastCond = cond;}
    int getLastCond(){return lastCond;}
    void output();
};
...
// 居然真的有人会点开这个假Commit看？？？哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈
// 懂的都懂好吧，Git可以指定提交者的名字和邮箱，所以我就把这个假Commit的名字和邮箱改了
// 版本管理太难做了，只能这样做做样子了，这些吐槽merge就会删了，结果你居然点进来了
// MachineCode.cpp 里面还有破防实录，LinearScan两个文件有两个冷笑话，可以去看看
